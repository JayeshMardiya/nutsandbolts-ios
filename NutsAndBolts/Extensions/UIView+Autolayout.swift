...
public let layoutPriorityAlmostRequired = UILayoutPriority.required - 1.0
...
public struct LayoutConstraintProperties {
    ...
    mutating func layoutConstraintPropertiesMake(relation: NSLayoutConstraint.Relation, multiplier: CGFloat, priority: UILayoutPriority) {
        self.relation = relation
        self.multiplier = multiplier
        self.priority = priority
    }
    
    mutating func layoutConstraintPropertiesWithRelation(relation: NSLayoutConstraint.Relation) {
        return layoutConstraintPropertiesMake(relation: relation, multiplier: 1.0, priority: UILayoutPriority.required)
    }
    
    mutating func layoutConstraintPropertiesWithMultiplier(multiplier: CGFloat) {
        return layoutConstraintPropertiesMake(relation: .equal, multiplier: multiplier, priority: UILayoutPriority.required)
    }
...
public extension UIView {
    ...
    @discardableResult
    func constraintAlignment(alignment: NSLayoutConstraint.Attribute, toView: UIView, distance: CGFloat) -> NSLayoutConstraint! {
    ...
    @discardableResult
    func constraintAlignment(alignment: NSLayoutConstraint.Attribute, toView: UIView, viewAlignment: NSLayoutConstraint.Attribute, distance: CGFloat) -> NSLayoutConstraint! {
